...
# df2 (within groups/residuals) = 94
# Common alpha levels: 0.05, 0.01, 0.001

# Critical values at different significance levels:
critical_f_05 <- qf(0.95, df1 = 2, df2 = 94)
critical_f_01 <- qf(0.99, df1 = 2, df2 = 94)
critical_f_001 <- qf(0.999, df1 = 2, df2 = 94)
...
cat("The F-statistic is: 218\n")
cat("Ratio to most extreme critical value (α=0.001) to the F statistic:", round(218/critical_f_001, 1), "x\n")
```
