...
mu <- 79        # mean height in inches
sigma <- 3.89   # standard deviation in inches

# Example: Calculate z-score for a specific height
height <- 77    # example height in inches
